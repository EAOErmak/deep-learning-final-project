...
def main() -> int:
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        val_metrics = trainer.eval_epoch(val_loader, epoch=epoch) if len(val_dataset) > 0 else {'loss': train_metrics['loss'], 'pos_loss': train_metrics['pos_loss'], 'conf_loss': train_metrics['conf_loss'], 'seen_sample_ids': set(), 'per_demo_loss': {}, 'per_demo_seen_counts': {}}
